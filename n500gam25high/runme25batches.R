...
#Sample size:
n=500.   #We test n=100 with pn=12, 300 with pn=15 and 500 with pn=16
# censoring="low"
censoring="high"
...
cat("BAR:\n",
    "Sum of TP in bar                                                                      =",sum(d$TP.bar[!is.na(d$TP.bar)]),"\n",
    "Sum of FP in bar                                                                      =",sum(d$FP.bar[!is.na(d$FP.bar)]),"\n",
    "Sum of FN in bar                                                                      =",sum(d$FN.bar[!is.na(d$FN.bar)]),"\n",
    
    "LASSO:\n",
    "Sum of TP in lasso                                                                    =",sum(d$TP.lasso[!is.na(d$TP.lasso)]),"\n",
    "Sum of FP in lasso                                                                    =",sum(d$FP.lasso[!is.na(d$FP.lasso)]),"\n",
    "Sum of FN in lasso                                                                    =",sum(d$FN.lasso[!is.na(d$FN.lasso)]),"\n",
    
    "Adaptive lasso\n",
    "Sum of TP in .ada                                                                     =",sum(d$TP.ada[!is.na(d$TP.ada)]),"\n",
    "Sum of FP in .ada                                                                     =",sum(d$FP.ada[!is.na(d$FP.ada)]),"\n",
    "Sum of FN in ada                                                                      =",sum(d$FN.ada[!is.na(d$FN.ada)]),"\n","\n\n\n\n\n\n\n\n\n")
...
print(d$MSE.ada)
print("this is complete vector of MC for Lasso:")
print(d$MC.lasso)
print("this is complete vector of MC for AdaLasso:")
print(d$MC.ada)
print("this is complete vector of MC for BAR:")
print(d$MC.bar)
sink()
