...
genWB.simData.10cov.BP.BS <- function(weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength ){
...
genWB.simData.12cov.BP.BS<- function(weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength){
  #frailty parameter:
  theta.true = ifelse(frailty == T, 0.25, 0)
  #Weibull parameters:
  log.kappa1.true =weibull.param.log[1]
...
genWB.simData.15cov.BP.BS<- function(weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength){
  #frailty parameter:
  theta.true = ifelse(frailty == T, 0.25, 0)
  #Weibull parameters:
  log.kappa1.true =weibull.param.log[1]
...
genWB.simData.16cov.BP.BS<- function(weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength){
  #frailty parameter:
  theta.true = ifelse(frailty == T, 0.25, 0)
  #Weibull parameters:
  log.kappa1.true =weibull.param.log[1]
...
genWB.simData.20cov.BP.BS<- function(weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength){
  #frailty parameter:
  theta.true = ifelse(frailty == T, 0.25, 0)
  #Weibull parameters:
  log.kappa1.true =weibull.param.log[1]
...
genWB.simData.10cov.BP.BS.grp<- function(G1,G2,G3,G4,G1.distr,G2.distr,G3.distr,G4.distr,mu.bernoulli,weibull.param.log,c1,c2,lt1,lt2,beta1.true,beta2.true,beta3.true,n ,m,yvalslength, rho,frailty ,risks.status){
  #frailty parameter:
  theta.true = ifelse(frailty == T, 0.25, 0)
  #Weibull parameters:
