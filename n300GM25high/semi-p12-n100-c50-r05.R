...
setwd(getwd())
#setwd("/Users/fmahmoudi/Documents/Research/GNST2023/JNSRev/codeUnderConstruction/revised-mywork-Frailty-GM/bp")
#replace this directory with the one of the unzipped files
# setwd("/Users/fatemehmahmoudi/Desktop/ARC-BSpline/ARC-BS-BAR")
source("sim-functions-bp-revised2.R")
source("varsel-functions-bp-revised-2.R")
###########################################################################
###################n=?,rho=?################

# For running batches on Arc automatically: -------------------------------
...
# theta.given=2.87 #This is the theta value that we get using the following 5 parameters for the GM model:
