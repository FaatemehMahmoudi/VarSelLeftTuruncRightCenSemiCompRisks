...
for start_seed in $(seq 1 50 500); do
    ...
    batch_dir="/home/fatemeh.mahmoudi/sg-indiv/BP-Nov1024/n300/GM/GM25/high/batch_${start_seed}_to_${end_seed}"
    ssh fatemeh.mahmoudi@arc.ucalgary.ca "mkdir -p $batch_dir"

    # Copy files to ARC
    rsync -avx sim-functions-bp-revised2.R varsel-functions-bp-revised-2.R semi-p12-n100-c50-r05.R scriptsgindivp10.sh \
