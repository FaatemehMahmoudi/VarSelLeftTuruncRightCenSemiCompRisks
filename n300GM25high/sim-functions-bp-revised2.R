...
simID.LT <- function(mu1,mu2,sigma1,sigma2,p1,p2,x1, x2, x3, beta1.true, beta2.true, beta3.true,
...
genWB.simData.10cov.BP.BS <- function(mu1,mu2,sigma1,sigma2,p1,p2,weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength,theta.given,frailty_distribution){
  ...
  Y.tmp = data.frame(simID.LT(mu1,mu2,sigma1,sigma2,p1,p2,x1, x2, x3, beta1.true, beta2.true, beta3.true,
                              alpha1.true, alpha2.true, alpha3.true,
...
genWB.simData.12cov.BP.BS<- function(mu1,mu2,sigma1,sigma2,p1,p2,weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength,theta.given,frailty_distribution){
  #frailty parameter:
  # theta.true = ifelse(frailty == T, 0.25, 0)
  theta.true = ifelse(frailty == T, theta.given, 0)
  #Weibull parameters:
  ...
  if (frailty == T) startVals.bs = c(startVals.bs, log(theta.true))
  startVals.bs = c(startVals.bs, beta1.true, beta2.true, beta3.true)
  #print("I am here at line 566")
  #print("I am here at line 569")
...
genWB.simData.15cov.BP.BS<- function(mu1,mu2,sigma1,sigma2,p1,p2,weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength,theta.given,frailty_distribution){
  #frailty parameter:
  # theta.true = ifelse(frailty == T, 0.25, 0)
  theta.true = ifelse(frailty == T, theta.given, 0)
  #Weibull parameters:
...
genWB.simData.16cov.BP.BS<- function(mu1,mu2,sigma1,sigma2,p1,p2,weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength,theta.given,frailty_distribution){
  #frailty parameter:
  # theta.true = ifelse(frailty == T, 0.25, 0)
  theta.true = ifelse(frailty == T, theta.given, 0)
  #Weibull parameters:
...
genWB.simData.20cov.BP.BS<- function(mu1,mu2,sigma1,sigma2,p1,p2,weibull.param.log,c1,c2,lt1,lt2,n ,m,rho,beta1.true,beta2.true,beta3.true, frailty , risks.status,yvalslength,theta.given,frailty_distribution){
  #frailty parameter:
  # theta.true = ifelse(frailty == T, 0.25, 0)
  theta.true = ifelse(frailty == T, theta.given, 0)
  #Weibull parameters:
